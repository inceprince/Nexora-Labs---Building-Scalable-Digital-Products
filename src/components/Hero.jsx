        ...
        <div className="text-center">
          ...
          >
            <span className="inline-block px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold">
              🚀 Bangalore's Leading Product Development Studio
            </span>
          </motion.div>
          ...
          >
            Building Scalable
            <span className="block text-blue-600">Digital Products</span>
          </motion.h1>
          ...
          >
            We help startups and enterprises turn ideas into powerful, production-ready web applications that scale.
          </motion.p>
          ...
          >
            <motion.button
              ...
              className="px-8 py-4 bg-blue-600 text-white rounded-lg font-semibold text-lg hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2"
            >
              Get Started
              <ArrowRight size={20} />
            </motion.button>
